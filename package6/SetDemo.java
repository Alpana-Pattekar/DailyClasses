...
public class SetDemo {
	...
	public static void main(String[] args) {
		...
		Student std1 = new Student(101, "Alpana", 23);
		Student std2 = new Student(102, "Tejas", 21);
		Student std3 = new Student(103, "Rasika", 20);
		Student std4 = new Student(104, "Tarun", 22);
		Student std5 = new Student(104, "Anup", 22);
		Student std6 = std1;
